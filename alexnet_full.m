...
%% import pretrained network and set options
net=alexnet;

%If using AlexNet:
lgraph = layerGraph(net.Layers); 

learnableLayer=lgraph.Layers(23);
classLayer=lgraph.Layers(25);
...
function [] = printToFile(labels)
    ...
    fileID = fopen('Team1_submission18.txt','w'); % will have to change 'w' if want to append instead of overwrite
